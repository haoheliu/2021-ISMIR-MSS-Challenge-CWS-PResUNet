...
import sys
sys.path.append("/mnt/fast/nobackup/scratch4weeks/hl01486/project/2021-ISMIR-MSS-Challenge-CWS-PResUNet")
...
class INDIVIDUAL_LOADER_test(Dataset):
    '''
        {
    ...
    def __init__(self):
        ...
        """
        # self.train_dir = "/mnt/fast/nobackup/scratch4weeks/hl01486/project/2021-ISMIR-MSS-Challenge-CWS-PResUNet/specskin/LibriTTS-fs2-1308-smallset/test_small"
        self.train_dir = "/mnt/fast/nobackup/scratch4weeks/hl01486/project/2021-ISMIR-MSS-Challenge-CWS-PResUNet/specskin/mel_real_test_50samples"
...
if __name__ == "__main__":
    loader = INDIVIDUAL_LOADER_test()
    for i, each in enumerate(loader):
