...
class EncoderBlockRes8(nn.Module):
    def __init__(self, in_channels, out_channels, downsample, activation, momentum):
        ...
        self.conv_block6 = ConvBlockRes(out_channels, out_channels, size, activation, momentum)
        self.conv_block7 = ConvBlockRes(out_channels, out_channels, size, activation, momentum)
        self.conv_block8 = ConvBlockRes(out_channels, out_channels, size, activation, momentum)
        self.downsample = downsample
...
class DecoderBlockRes8(nn.Module):
    def __init__(self, in_channels, out_channels, stride, activation, momentum):
        ...
        self.conv_block7 = ConvBlockRes(out_channels, out_channels, size, activation, momentum)
        self.conv_block8 = ConvBlockRes(out_channels, out_channels, size, activation, momentum)
        self.conv_block9 = ConvBlockRes(out_channels, out_channels, size, activation, momentum)
...
class EncoderBlockRes2(nn.Module):
    def __init__(self, in_channels, out_channels, downsample, activation, momentum):
        super(EncoderBlockRes2, self).__init__()
        size = 3
...
class DecoderBlockRes2(nn.Module):
    def __init__(self, in_channels, out_channels, stride, activation, momentum):
        super(DecoderBlockRes2, self).__init__()
        size = 3
        self.activation = activation
        self.stride = stride
...
class EncoderBlockRes4(nn.Module):
    def __init__(self, in_channels, out_channels, downsample, activation, momentum):
        super(EncoderBlockRes4, self).__init__()
        size = 3
...
class DecoderBlockRes4(nn.Module):
    def __init__(self, in_channels, out_channels, stride, activation, momentum):
        super(DecoderBlockRes4, self).__init__()
        size = 3
        self.activation = activation
        self.stride = stride
